#!/bin/bash -l
#SBATCH -D /home/lavila/projects/282inversions/1MB_windows/chr1/PCS/
...
#sbatch -p bigmemm -t 12:00:00  --mem 10000   slurm-scripts/run-tasselMDS_chr1_1MB_array.sh
