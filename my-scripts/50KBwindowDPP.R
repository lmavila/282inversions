library(DPP)
setwd("/home/lavila/projects/282inversions/50KB_windows/chr3")
...
concentration_parameter_alpha= 0.8902882 #from whole genome estimation of chi_G and fitting
concentration_parameter_beta=10;

# mcmc settings
generations <- 1000
expectedClusters <- 2.764011 #from whole genome estimation with DPP
num_runs <-1
